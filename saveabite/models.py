...
class food_data(models.Model):
    ...
    image = models.ImageField(upload_to='market_pics/')
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    quantity = models.TextField(max_length=200, default='Unknown', blank=True, null=True)
    allergy_rating = models.CharField(max_length=255, default='none')
    dietary_rating = models.CharField(max_length=255, blank=True, null=True)
...
class user_signup(models.Model):
    ...
    country = CountryField(default='Canada')
